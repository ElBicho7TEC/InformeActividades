...
require('C:\xampp\htdocs\informeActividades\html\fpdf\fpdf.php'); // esta direccion se debe cambiar a la de donde se aloja la carpeta
...
foreach ($_POST['id'] as $checkbox) // los datos del post de id se recorren 
    ...
    foreach ($Resultadoactividades as $Datosactividades) 
     ...
     $pdf->Cell(0,10,'Elaboro: '.$apellidoPaterno.' '.$apellidoMaterno.' '.$Nombre.'                       Fecha: '.$fechaactividad,1,1,'J');
     }  
    }
  $pdf->Output('prueba','I');
  }
